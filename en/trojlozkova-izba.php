	...
	<div id="room-3" class="page-room">
		...
		<main class="container">
			<section>
				...
				<div class="room-img">
					<img src="../assets/img/trojka/trojka(1).jpg" alt="prezentation-room">
				</div>
			</section>
			...
			<section>
				<div class="room-text">
					...
					<ul>
						...
						<li>Smart LED television with satellite</li>
				...
				<div class="room-img">
					<img src="../assets/img/trojka/third(1).jpg" alt="breakfast" >
				</div>
			</section>

			<div class="price container">
				<span>Price from 55€</span>
			</div>
		</main>
