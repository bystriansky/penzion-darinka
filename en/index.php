...
<body>
	<div class="page-home">
		...
		<header>
			...
			<h1>Accommodation in the family environment</h1>

			<p class="rekreacne-poukazy">Possible to use holiday vouchers with AquaCity Poprad extra services</p>

			<div class="header-pc">
				<a href="ubytovanie.php" title="Vyberte si izbu" class="btn">Choose a room</a>
			</div>
			...
			<ul class="header-phone">
				...
				<li><a href="ubytovanie.php" title="Vyberte si izbu" class="btn">Choose a room</a></li>
			</ul>
		</header>
		...
		<main class="container">
			...
			<section>
				...
				<img src="../assets/img/backgrounds/back-kontakt.jpg" alt="pesion-view">
			</section>

			<section>
				<h2>AquaCity discount 15%</h2>
				<img src="../assets/img/aquacity.jpg" alt="aquacity">
			</section>
		</main>
